...
extern void F1777_20144(EIF_REFERENCE);
extern void F1777_20145(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1777_20146(EIF_REFERENCE);
static EIF_TYPED_VALUE F1777_20147_body(EIF_REFERENCE);
...
void F1777_20144 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1776, Current, 0, 0, 26367);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1776, Current, 26367);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 16826, 0x04000000, 1); /* focus_on_press_disabled */
	*(EIF_BOOLEAN *)(Current + RTWA(16826, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F1777_20145 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1776, Current, 0, 0, 26368);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1776, Current, 26368);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 16826, 0x04000000, 1); /* focus_on_press_disabled */
	*(EIF_BOOLEAN *)(Current + RTWA(16826, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
static EIF_TYPED_VALUE F1777_20147_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1776, Current, 0, 0, 26370);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F1777_20147 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15734, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1777_20147_body (Current)).it_r;
