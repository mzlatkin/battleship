...
extern void F1497_16385(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1497_16386(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1497_16387(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1497_16388(EIF_REFERENCE);
extern void F1497_25661(EIF_REFERENCE, int);
...
void F1497_16385 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1496, Current, 1, 1, 23105);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1496, Current, 23105);
	{
		...
		RTCC(arg1, 1496, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 13728, 0x10000000, 1); /* count */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2269, "count", arg1))(arg1)).it_i4);
	*(EIF_INTEGER_32 *)(Current + RTWA(13728, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(3);
	...
	up1 = loc1;
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(13728, dtype));
	ui4_1 = ti4_1;
	...
	if (RTAL & CK_ENSURE) {
		...
		ui4_1 = ti4_1;
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(13727, dtype))(Current, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		if (RTEQ(tr1, arg1)) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F1497_16386 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1496, Current, 2, 1, 23106);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1496, Current, 23106);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
	loc1 = *(EIF_INTEGER_32 *)(Current + RTWA(13728, dtype));
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(13728, dtype));
...
EIF_TYPED_VALUE F1497_16387 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(13728,Dtype(Current)));
	return r;
}


/* {WEL_CHARACTER_ARRAY}.structure_size */
EIF_TYPED_VALUE F1497_16388 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1496, Current, 0, 0, 23108);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1497_25661 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1496, Current, 0, 25660);
	RTSA(dtype);
	RTME(dtype, 0);
