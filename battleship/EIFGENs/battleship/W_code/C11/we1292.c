...
extern EIF_TYPED_VALUE F1292_13400(EIF_REFERENCE);
...
RTOID (F1292_13400)
EIF_TYPED_VALUE F1292_13400 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1291, Current, 0, 0, 19618);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1291, Current, 19618);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
