...
extern EIF_TYPED_VALUE F1824_20857(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1824_20857 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1823, Current, 0, 0, 26999);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1823, Current, 26999);
	RTIV(Current, RTAL);
	RTHOOK(1);
