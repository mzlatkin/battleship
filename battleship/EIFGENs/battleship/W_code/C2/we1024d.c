...
static const EIF_TYPE_INDEX egt_13_1024 [] = {0xFF01,238,0xFFFF};
...
static const struct desc_info desc_1024[] = {
	...
	{EIF_GENERIC(egt_13_1024), 15964, 0xFFFFFFFF},
	...
	{EIF_NON_GENERIC(0x01C7 /*227*/), 15969, 0xFFFFFFFF},
};
void Init1024(void)
{
	IDSC(desc_1024, 0, 1023);
	IDSC(desc_1024 + 1, 1, 1023);
	IDSC(desc_1024 + 32, 738, 1023);
}
