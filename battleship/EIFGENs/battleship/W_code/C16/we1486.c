...
extern void F1486_16166(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1486_16167(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1486_16168(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1486_16169(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1486_16170(EIF_REFERENCE);
extern void F1486_25659(EIF_REFERENCE, int);
...
void F1486_16166 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1485, Current, 4, 1, 22884);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1485, Current, 22884);
	{
		...
		RTCC(arg1, 1485, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 13520, 0x10000000, 1); /* count */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2269, "count", arg1))(arg1)).it_i4);
	*(EIF_INTEGER_32 *)(Current + RTWA(13520, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(3);
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_1 = *(EIF_INTEGER_32 *)(arg1 + RTVA(2665, "lower", arg1));
		ui4_1 = ti4_1;
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(13519, dtype))(Current, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		if (RTEQ(tr1, arg1)) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F1486_16167 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 1485, Current, 4, 1, 22885);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(2);
	RTDBGAL(Current, 3, 0x10000000, 1, 0); /* loc3 */
	loc3 = *(EIF_INTEGER_32 *)(Current + RTWA(13520, dtype));
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(13520, dtype));
...
EIF_TYPED_VALUE F1486_16168 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(13520,Dtype(Current)));
	return r;
}


/* {WEL_INTEGER_ARRAY}.structure_size */
EIF_TYPED_VALUE F1486_16169 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1485, Current, 0, 0, 22887);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1486_16170 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
void F1486_25659 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1485, Current, 0, 25658);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("positive_count", Current);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(13520, dtype));
