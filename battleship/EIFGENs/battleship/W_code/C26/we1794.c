...
extern EIF_TYPED_VALUE F1794_20328(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1794_20329(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1794_20330(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1794_20328 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1793, Current, 0, 1, 26530);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1793, Current, 26530);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1794_20329 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1793, Current, 0, 0, 26531);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1793, Current, 26531);
	RTIV(Current, RTAL);
	...
	if (RTAL & CK_ENSURE) {
		...
		ui4_1 = Result;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(16987, dtype))(Current, ui4_1x)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F1794_20330 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1793, Current, 1, 1, 26532);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1793, Current, 26532);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("an_id_non_negative", EX_PRE);
...
body:;
	...
	loc1 = RTCCL(tr1);
	loc1 = RTRV(RTWCT(16989, dtype, Dftype(Current)),loc1);
	if (EIF_TEST(loc1)) {
		RTHOOK(3);
