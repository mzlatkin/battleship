...
static EIF_TYPED_VALUE F1699_19435_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1699_19435(EIF_REFERENCE);
extern void F1699_25712(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1699_19435_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1698, Current, 0, 0, 26013);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1698, Current, 26013);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1699_19435 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15734, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1699_19435_body (Current)).it_r;
...
void F1699_25712 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1698, Current, 0, 25711);
	RTSA(dtype);
	RTME(dtype, 0);
