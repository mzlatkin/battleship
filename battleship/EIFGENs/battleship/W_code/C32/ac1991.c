...
extern void F1991_4188(EIF_REFERENCE);
extern void F1991_4189(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1991_4190(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1991_4191(EIF_REFERENCE);
extern void F1991_4192(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1991_4193(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1991_4194(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1991_7164(EIF_REFERENCE, int);
...
void F1991_4188 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1990, Current, 0, 0, 20615);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1990, Current, 20615);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 3109, 0xF80003AB, 0); /* add_actions */
	...
	*(EIF_REFERENCE *)(Current + RTWA(3109, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3110, 0xF80003AB, 0); /* remove_actions */
...
void F1991_4189 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1990, Current, 0, 1, 20616);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1990, Current, 20616);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1991_4190 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1991_4191 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1991_4192 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1990, Current, 1, 2, 20619);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1990, Current, 20619);
	RTCC(arg1, 1990, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1991_4193 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1990, Current, 1, 2, 20620);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1990, Current, 20620);
	RTCC(arg1, 1990, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F1991_4194 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1990, Current, 0, 1, 20621);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1990, Current, 20621);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAL(Current, 0, 0xF80007C6, 0,0); /* Result */
...
void F1991_7164 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1990, Current, 0, 7163);
	RTSA(dtype);
	RTME(dtype, 0);
