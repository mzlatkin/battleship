...
static const EIF_TYPE_INDEX egt_13_1080 [] = {0xFF01,1375,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1080 [] = {0xFF01,1362,0xFFFF};
...
static const struct desc_info desc_1080[] = {
	...
	{EIF_GENERIC(egt_13_1080), 16788, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1080), 16789, 0xFFFFFFFF},
};
void Init1080(void)
{
	IDSC(desc_1080, 0, 1079);
	IDSC(desc_1080 + 1, 1, 1079);
	IDSC(desc_1080 + 32, 1241, 1079);
}
