...
extern EIF_TYPED_VALUE F1061_10174(EIF_REFERENCE);
...
RTOID (F1061_10174)
EIF_TYPED_VALUE F1061_10174 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1060, Current, 0, 0, 16504);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1060, Current, 16504);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800054C, 0,0); /* Result */
