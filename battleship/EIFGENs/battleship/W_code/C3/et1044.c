...
extern void F1044_25629(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1043, Current, 0, 0, 16339);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1043, Current, 16339);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F1044_25629 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1043, Current, 0, 25628);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
