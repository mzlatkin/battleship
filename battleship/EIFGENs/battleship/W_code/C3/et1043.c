...
extern void F1043_25629(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1042, Current, 0, 0, 16337);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1042, Current, 16337);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000411, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1041, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(7781, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
...
void F1043_25629 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1042, Current, 0, 25628);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
	...
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7788, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	if (RTCEQ(tr1, tr2)) {
		RTCK;
	} else {
		RTCF;
