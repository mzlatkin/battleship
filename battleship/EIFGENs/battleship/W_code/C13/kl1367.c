...
extern EIF_TYPED_VALUE F1367_14408(EIF_REFERENCE);
...
RTOID (F1367_14408)
EIF_TYPED_VALUE F1367_14408 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1366, Current, 0, 0, 21068);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1366, Current, 21068);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
