...
extern EIF_TYPED_VALUE F1354_14338(EIF_REFERENCE);
...
RTOID (F1354_14338)
EIF_TYPED_VALUE F1354_14338 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1353, Current, 0, 0, 20978);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1353, Current, 20978);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
