...
extern EIF_TYPED_VALUE F1323_14075(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1323_14075 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1322, Current, 0, 1, 20283);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1322, Current, 20283);
	RTCC(arg1, 1322, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
