...
extern void F2018_3562(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2018_3563(EIF_REFERENCE);
extern void F2018_3564(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2018_3565(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2018_3566(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2018_3567(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2018_3568(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2018_3569(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F2018_3562 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2017, Current, 1, 1, 20489);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2017, Current, 20489);
	{
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F2018_3563 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2017, Current, 1, 0, 20490);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2017, Current, 20490);
	RTIV(Current, RTAL);
	if (RTAL & CK_CHECK) {
		RTHOOK(1);
...
/* {LINKED_STACK}.force */
void F2018_3564 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2017, Current, 0, 1, 20491);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2017, Current, 20491);
	RTCC(arg1, 2017, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
/* {LINKED_STACK}.extend */
void F2018_3565 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2017, Current, 0, 1, 20484);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2017, Current, 20484);
	RTCC(arg1, 2017, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_STACK}.put */
void F2018_3566 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2017, Current, 0, 1, 20485);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(2017, Current, 20485);
	RTCC(arg1, 2017, l_feature_name, 1, RTWCT(2258, Dtype(Current), Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2707, Dtype(Current)))(Current, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
/* {LINKED_STACK}.remove */
void F2018_3567 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2017, Current, 0, 0, 20486);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2017, Current, 20486);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F2018_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2017, Current, 1, 0, 20487);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2017, Current, 20487);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		RTHOOK(4);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(2775, dtype));
		if (tb1) break;
		RTHOOK(5);
...
EIF_TYPED_VALUE F2018_3569 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2017, Current, 3, 1, 20488);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2017, Current, 20488);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		...
		if (tb2) {
			tb2 = *(EIF_BOOLEAN *)(Current + RTWA(2775, dtype));
			tb1 = tb2;
		}
		RTTE(tb1, label_1);
		RTCK;
...
body:;
	...
	if ((EIF_BOOLEAN) !tb1) {
		...
		for (;;) {
			...
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2778, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr1);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2709, "put_right", loc3))(loc3, ur1x);
			RTHOOK(12);
