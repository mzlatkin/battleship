...
extern EIF_TYPED_VALUE F983_8937(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_8938(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_8939(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_8940(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_8941(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F983_8942(EIF_REFERENCE);
...
RTOID (F983_8937)
EIF_TYPED_VALUE F983_8937 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 982, Current, 3, 0, 15224);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 15224);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	ur1 = tr1;
	loc2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6729, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(2);
	tb1 = '\0';
	...
	if (tb1) {
		...
		ur1 = tr1;
		loc3 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6729, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTHOOK(6);
		tb1 = '\0';
		...
		if (tb1) {
			...
			loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6728, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTHOOK(9);
...
RTOID (F983_8938)
EIF_TYPED_VALUE F983_8938 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 982, Current, 2, 0, 15225);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 15225);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 2, 0xF80000E8, 0, 0); /* loc2 */
...
RTOID (F983_8939)
EIF_TYPED_VALUE F983_8939 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_BOOLEAN)
	...
	RTEAA(l_feature_name, 982, Current, 1, 0, 15226);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(982, Current, 15226);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F983_8940 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 15227);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 15227);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E8, 0,0); /* Result */
	Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6730, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
EIF_TYPED_VALUE F983_8941 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 982, Current, 1, 1, 15228);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 15228);
...
RTOID (F983_8942)
EIF_TYPED_VALUE F983_8942 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 15229);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 15229);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (8937,F983_8937)
	RTOTS (8938,F983_8938)
	RTOTS (8939,F983_8939)
	RTOTS (8942,F983_8942)
}
