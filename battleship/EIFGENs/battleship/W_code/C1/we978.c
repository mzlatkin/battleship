...
extern EIF_TYPED_VALUE F978_8872(EIF_REFERENCE);
extern EIF_TYPED_VALUE F978_8873(EIF_REFERENCE);
extern EIF_TYPED_VALUE F978_8874(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F978_8872 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F978_8873 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F978_8874 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 977, Current, 0, 1, 15161);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(977, Current, 15161);
	RTIV(Current, RTAL);
	RTHOOK(1);
