...
extern void F965_7245(EIF_REFERENCE);
extern void F965_7246(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F965_7250(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#ifndef INLINE_F965_7249
static EIF_INTEGER_32 inline_F965_7249 (void)
{
	{
...
#define INLINE_F965_7249
#endif
#ifndef INLINE_F965_7250
static EIF_NATURAL_64 inline_F965_7250 (EIF_POINTER arg1)
{
	{
...
void F965_7245 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5036, 0xF80000AB, 0); /* item */
	...
	tr1 = RTCCL(tr1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5036, dtype)) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F965_7246 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 964, Current, 0, 1, 13533);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	if ((EIF_BOOLEAN)(tp1 != tp2)) {
		...
		tp1 = *(EIF_POINTER *)(tr1 + RTVA(3281, "item", tr1));
		up1 = tp1;
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5038, dtype))(Current, up1x)).it_n8);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
EIF_TYPED_VALUE F965_7250 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 964, Current, 0, 1, 13537);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(964, Current, 13537);
	RTIV(Current, RTAL);
	Result = inline_F965_7250 ((EIF_POINTER) arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
	RTDBGLE;
