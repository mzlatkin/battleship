...
extern void F975_8826(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F975_8827(EIF_REFERENCE);
extern EIF_TYPED_VALUE F975_8828(EIF_REFERENCE);
...
void F975_8826 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 974, Current, 0, 1, 15113);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(974, Current, 15113);
	RTCC(arg1, 974, l_feature_name, 1, eif_new_type(996, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6615, 0xF80003E4, 0); /* guid */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(6615, dtype)) = (EIF_REFERENCE) tr1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("set", EX_POST);
...
EIF_TYPED_VALUE F975_8827 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F975_8828 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 974, Current, 2, 0, 15115);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(974, Current, 15115);
	RTIV(Current, RTAL);
	RTHOOK(1);
