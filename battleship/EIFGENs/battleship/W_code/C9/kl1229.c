...
extern EIF_TYPED_VALUE F1229_12890(EIF_REFERENCE);
...
RTOID (F1229_12890)
EIF_TYPED_VALUE F1229_12890 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1228, Current, 0, 0, 19128);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1228, Current, 19128);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
