...
/* {EV_ID_IMP}.make_id */
void F1281_13239 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1280, Current, 0, 0, 19471);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1280, Current, 19471);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10924, 0x10000000, 1); /* id */
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(10924, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10925, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(2,1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1280, Current, 0, 0, 19473);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1280, Current, 19473);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F1281_25635 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1280, Current, 0, 25634);
	RTSA(dtype);
	RTME(dtype, 0);
