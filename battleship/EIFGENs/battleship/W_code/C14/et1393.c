/*
 * Code for class ETF_CUSTOM_SETUP
 */
...
extern void F1393_14750(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {ETF_CUSTOM_SETUP}.custom_setup */
void F1393_14750 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x)
{
	GTCX
	char *l_feature_name = "custom_setup";
	RTEX;
...
#define ui8_4 ui8_4x.it_i8
	...
	RTEAA(l_feature_name, 1392, Current, 0, 4, 21436);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("custom_setup_precond(dimension, ships, max_shots, num_bombs)", EX_PRE);
		ui8_1 = arg1;
		ui8_2 = arg2;
		ui8_3 = arg3;
		ui8_4 = arg4;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(12231, dtype))(Current, ui8_1x, ui8_2x, ui8_3x, ui8_4x)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTJB;
label_1:
