...
extern void F1405_14773(EIF_REFERENCE);
...
/* {ETF_GIVE_UP}.give_up */
void F1405_14773 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "give_up";
	RTEX;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1404, Current, 0, 0, 21453);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1404, Current, 21453);
	RTIV(Current, RTAL);
	RTHOOK(1);
