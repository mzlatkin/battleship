...
extern void F1397_14758(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1397_14758 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 1396, Current, 0, 1, 21442);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1396, Current, 21442);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("debug_test_precond(level)", EX_PRE);
		ui8_1 = arg1;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(12235, dtype))(Current, ui8_1x)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTJB;
label_1:
