...
static const EIF_TYPE_INDEX egt_13_1117 [] = {0xFF01,1348,0xFFFF};
...
static const struct desc_info desc_1117[] = {
	...
	{EIF_GENERIC(egt_13_1117), 17061, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0A89 /*1348*/), 17062, 0},
};
void Init1117(void)
{
	IDSC(desc_1117, 0, 1116);
	IDSC(desc_1117 + 1, 1, 1116);
	IDSC(desc_1117 + 32, 986, 1116);
}
