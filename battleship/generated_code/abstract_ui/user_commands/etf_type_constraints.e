...
feature -- type queries 
	...
	is_grid_size(etf_v: INTEGER_64): BOOLEAN 
		require
			comment("etf_v: GRID_SIZE = 4 .. 12")
		do
			 Result := 
				(4 <= etf_v) and then (etf_v <= 12)
		ensure
			 Result = 
				(4 <= etf_v) and then (etf_v <= 12)
		end

	is_number_of_ships(etf_v: INTEGER_64): BOOLEAN 
		require
			comment("etf_v: NUMBER_OF_SHIPS = 1 .. 7")
		do
			 Result := 
				(1 <= etf_v) and then (etf_v <= 7)
		ensure
			 Result = 
				(1 <= etf_v) and then (etf_v <= 7)
		end

	is_max_shots(etf_v: INTEGER_64): BOOLEAN 
		require
			comment("etf_v: MAX_SHOTS = 1 .. 144")
		do
			 Result := 
				(1 <= etf_v) and then (etf_v <= 144)
		ensure
			 Result = 
				(1 <= etf_v) and then (etf_v <= 144)
		end

	is_number_of_bombs(etf_v: INTEGER_64): BOOLEAN 
		require
			comment("etf_v: NUMBER_OF_BOMBS = 1 .. 7")
		do
			 Result := 
				(1 <= etf_v) and then (etf_v <= 7)
		ensure
...
feature -- query on declarations of event parameters
	evt_param_types_table : HASH_TABLE[HASH_TABLE[ETF_PARAM_TYPE, STRING], STRING]
		local
			...
			custom_setup_param_types: HASH_TABLE[ETF_PARAM_TYPE, STRING]
			custom_setup_test_param_types: HASH_TABLE[ETF_PARAM_TYPE, STRING]
		...
		do
			...
			create custom_setup_param_types.make (10)
			custom_setup_param_types.compare_objects
			custom_setup_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("GRID_SIZE", create {ETF_INTERVAL_PARAM}.make(4, 12)), "dimension")
			custom_setup_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("NUMBER_OF_SHIPS", create {ETF_INTERVAL_PARAM}.make(1, 7)), "ships")
			custom_setup_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("MAX_SHOTS", create {ETF_INTERVAL_PARAM}.make(1, 144)), "max_shots")
			custom_setup_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("NUMBER_OF_BOMBS", create {ETF_INTERVAL_PARAM}.make(1, 7)), "num_bombs")
			Result.extend (custom_setup_param_types, "custom_setup")
			create custom_setup_test_param_types.make (10)
			custom_setup_test_param_types.compare_objects
			custom_setup_test_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("GRID_SIZE", create {ETF_INTERVAL_PARAM}.make(4, 12)), "dimension")
			custom_setup_test_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("NUMBER_OF_SHIPS", create {ETF_INTERVAL_PARAM}.make(1, 7)), "ships")
			custom_setup_test_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("MAX_SHOTS", create {ETF_INTERVAL_PARAM}.make(1, 144)), "max_shots")
			custom_setup_test_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("NUMBER_OF_BOMBS", create {ETF_INTERVAL_PARAM}.make(1, 7)), "num_bombs")
			Result.extend (custom_setup_test_param_types, "custom_setup_test")
...
feature -- query on declarations of event parameters
	evt_param_types_list : HASH_TABLE[LINKED_LIST[ETF_PARAM_TYPE], STRING]
		local
			...
			custom_setup_param_types: LINKED_LIST[ETF_PARAM_TYPE]
			custom_setup_test_param_types: LINKED_LIST[ETF_PARAM_TYPE]
		...
		do
			...
			redo_param_types.compare_objects
			Result.extend (redo_param_types, "redo")
			create custom_setup_param_types.make
			custom_setup_param_types.compare_objects
			custom_setup_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("GRID_SIZE", create {ETF_INTERVAL_PARAM}.make(4, 12)))
			custom_setup_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("NUMBER_OF_SHIPS", create {ETF_INTERVAL_PARAM}.make(1, 7)))
			custom_setup_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("MAX_SHOTS", create {ETF_INTERVAL_PARAM}.make(1, 144)))
			custom_setup_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("NUMBER_OF_BOMBS", create {ETF_INTERVAL_PARAM}.make(1, 7)))
			Result.extend (custom_setup_param_types, "custom_setup")
			create custom_setup_test_param_types.make
			custom_setup_test_param_types.compare_objects
			custom_setup_test_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("GRID_SIZE", create {ETF_INTERVAL_PARAM}.make(4, 12)))
			custom_setup_test_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("NUMBER_OF_SHIPS", create {ETF_INTERVAL_PARAM}.make(1, 7)))
			custom_setup_test_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("MAX_SHOTS", create {ETF_INTERVAL_PARAM}.make(1, 144)))
			custom_setup_test_param_types.extend (create {ETF_NAMED_PARAM_TYPE}.make("NUMBER_OF_BOMBS", create {ETF_INTERVAL_PARAM}.make(1, 7)))
			Result.extend (custom_setup_test_param_types, "custom_setup_test")
